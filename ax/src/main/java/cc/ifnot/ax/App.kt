    ...
    override fun attachBaseContext(base: Context?) {
        ...
        try {
            ...
            for (e in entries) {
                ...
                Lg.d((e.value as IBinder).javaClass.name)
            }
//            val a = IBinder::class.java
            ...
            val binder = m.invoke(null, Context.ACTIVITY_SERVICE) as IBinder

            val proxy = Proxy.newProxyInstance(clz.classLoader, arrayOf(IBinder::class.java),
                    Handle(binder))
            ...
            Lg.d("binder: %s -- %s", iBinder, systemService)
